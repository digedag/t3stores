...
/**
 * Anzeige der Verkaufsaktionen
 * @author rene
 */
class PromotionList extends \tx_rnbase_action_BaseIOC {
	protected function handleRequest(&$parameters, &$configurations, &$viewdata) {
 		$srv = ServiceRegistry::getPromotionService();
	...
	public function getTemplateName() { return 'promotionlist';}
